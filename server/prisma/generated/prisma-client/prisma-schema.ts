...
type Mutation {
  ...
  updateOpenAuth(data: OpenAuthUpdateInput!, where: OpenAuthWhereUniqueInput!): OpenAuth
  updateManyOpenAuths(data: OpenAuthUpdateManyMutationInput!, where: OpenAuthWhereInput): BatchPayload!
  upsertOpenAuth(where: OpenAuthWhereUniqueInput!, create: OpenAuthCreateInput!, update: OpenAuthUpdateInput!): OpenAuth!
...
type Query {
  ...
  openAuths(where: OpenAuthWhereInput, orderBy: OpenAuthOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [OpenAuth]!
  openAuthsConnection(where: OpenAuthWhereInput, orderBy: OpenAuthOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): OpenAuthConnection!
